            ...
            <div class="box box-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/admin/userOrderAll?orderId=${p.orderId}&userId=${userId}'">订单项详情</button>
                                    </td>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/admin/userOrder?page=1&size=${pageinfo.pageSize}&userId=${userId}" aria-label="Previous">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/admin/userOrder?page=${pageinfo.pageNum-1}&size=${pageinfo.pageSize}&userId=${userId}">上一页</a></li>
                            <c:forEach begin="1" end="${pageinfo.pages}" var="pageNum">
                                <li><a href="${pageContext.request.contextPath}/admin/userOrder?page=${pageNum}&size=${pageinfo.pageSize}&userId=${userId}">${pageNum}</a></li>
                            </c:forEach>

                            <li><a href="${pageContext.request.contextPath}/admin/userOrder?page=${pageinfo.pageNum+1}&size=${pageinfo.pageSize}&userId=${userId}">下一页</a></li>
                            <li><a href="${pageContext.request.contextPath}/admin/userOrder?page=${pageinfo.pages}&size=${pageinfo.pageSize}&userId=${userId}" aria-label="Next">尾页</a></li>
                        </ul>
                    </div>
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/admin/userOrder?userId=${userId}&page=1&size="
            + pageSize;
    }

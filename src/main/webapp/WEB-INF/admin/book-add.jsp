...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				添加书籍管理 <small>数据列表</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li>
				<li><a href="#">添加书籍管理</a></li>
			...
			<!-- 正文区域 -->
			<form action="${pageContext.request.contextPath}/admin/bookAdd" method="post" enctype="multipart/form-data">
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="bookName" placeholder="书籍名称" >
						</div>					
                        ...
                        <div class="col-md-10 data">
                            ...
                            <input type="file" class="form-control" name="bookImages" value="bookImages">
                        </div>
                        ...
                        <div class="col-md-10 data">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="bookPrice" placeholder="书籍价格" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-10 data">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="bookNum" placeholder="书籍库存量" >
                            </div>
                        </div>
						...
						<div class="col-md-10 data ">
							<textarea class="form-control" rows="10" placeholder="书籍描述" name="bookDesc" ></textarea>
						</div>
                        <div class="col-md-12 ">

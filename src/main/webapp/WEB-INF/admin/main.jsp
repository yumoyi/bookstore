				...
				<div class="row">
					<div class="col-lg-4 col-xs-6">
						...
						<div class="small-box bg-aqua">
							...
							<a href="${pageContext.request.contextPath }/admin/order" class="small-box-footer">详细 <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					<!-- ./col -->
					<div class="col-lg-4 col-xs-6">
					...
					<div class="col-lg-4 col-xs-6">
						...
						<div class="small-box bg-yellow">
							...
							<a href="${pageContext.request.contextPath }/admin/user" class="small-box-footer">详细 <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
								...
								<c:forEach items="${pageinfo.list}" var="p" varStatus="status">
									...
									<tr>
										...
										<td>
											...
											<c:if test="${p.orderState==2}">已付款</c:if>
